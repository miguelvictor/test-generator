...
var Question = React.createClass({displayName: "Question",
	...
	render: function () {
		var choices = this.state.choices.map(function (choice) {
			return (
				React.createElement(Choice, {key: choice.id})
			);
		});
		return (
			React.createElement("div", {className: "exam-question"}, 
				React.createElement("span", null, "Question ", this.state.choices.id), 
...
var Exam = React.createClass({displayName: "Exam",
	...
	addQuestion: function () {
		...
		var questions = this.state.questions.push({'id': newId, 'questionText': ''});
