...
var Question = React.createClass({displayName: "Question",
	...
	render: function () {
		alert(JSON.stringify(this.props.src));
		var choices = this.props.src.choices.map(function (choice) {
			return React.createElement(Choice, {key: choice.id, src: choice});
		});
...
var Exam = React.createClass({displayName: "Exam",
	...
	addQuestion: function () {
		...
		questions.push(this.buildNewQuestion(newId));
